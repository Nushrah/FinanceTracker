...
/**
 * Stub PreparedStatement that throws SQLException on execution
 */
public class StubPreparedStatementForSQLException implements PreparedStatement {
    
    @Override
    public ResultSet executeQuery() throws SQLException {
        throw new SQLException("Test SQLException from stub PreparedStatement");
    }
