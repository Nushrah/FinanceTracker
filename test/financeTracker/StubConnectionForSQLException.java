...
/**
 * Stub Connection that returns a PreparedStatement which throws SQLException
 * Used for testing error handling branches
 */
public class StubConnectionForSQLException implements Connection {
    
    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        // Return a stub that will throw SQLException when executed
        return new StubPreparedStatementForSQLException();
    }
    ...
    public Statement createStatement() throws SQLException {
        throw new SQLException("Test SQLException from stub");
    }
    
    // Все остальные методы - минимальная реализация для компиляции
